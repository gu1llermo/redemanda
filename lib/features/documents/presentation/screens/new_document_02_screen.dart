...
import '../providers/forms/document_form_02_provider.dart';
...
class _NewDocument02ScreenState extends ConsumerState<NewDocument02Screen>
  ...
  @override
   Widget build(BuildContext context) {
    ...
    ref.listen(
      documentForm02Provider.select((state) => state.selectedIndex),
      (previous, next) {
    ...
    ref.listen(
      ...
      (previous, next) {
        ...
        ref.read(documentForm02Provider.notifier).resetError();
      },
    );
...
class _GenerateButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    final newDocumentState = ref.watch(documentForm02Provider);
    ...
    return FloatingActionButton.small(
      ...
      onPressed: newDocumentState.isPosting
          ? null
          : () {
              ref.read(documentForm02Provider.notifier).onFormSubmit().then(
                (document) {
                  if (document != null) {
    ...
    return CardModelInformation(
      ...
      children: [
        ...
        AdvancedAutocompleteTextFieldOverlay(
          ...
          onChanged:
              ref.read(documentForm02Provider.notifier).onDemandadoPrincipalRutChanged,
          errorMessage: newDocumentState.isFormPosted
    ...
    return CardModelInformation(
      ...
      children: [
        ...
        AdvancedAutocompleteTextFieldOverlay(
          ...
          onChanged:
              ref.read(documentForm02Provider.notifier).onDemandadoSolidarioRutChanged,
          errorMessage: newDocumentState.isFormPosted
    ...
    return CardModelInformation(
      ...
      children: [
        ...
        AdvancedAutocompleteTextFieldOverlay(
          ...
          onChanged:
              ref.read(documentForm02Provider.notifier).onAbogado1RutChanged,
          errorMessage: newDocumentState.isFormPosted
        ...
        AdvancedAutocompleteTextFieldOverlay(
          ...
          onChanged:
              ref.read(documentForm02Provider.notifier).onAbogado1EmailChanged,
          errorMessage: newDocumentState.isFormPosted
    ...
    return CardModelInformation(
      ...
      children: [
        ...
        AdvancedAutocompleteTextFieldOverlay(
          ...
          onChanged:
              ref.read(documentForm02Provider.notifier).onDemandanteRutChanged,
          errorMessage: newDocumentState.isFormPosted
                  ...
                  child: Wrap(
                    ...
                    children: [
                      ...
                      AdvancedAutocompleteTextFieldOverlay(
                        ...
                        width: 300,
                        labelText: 'COMUNA',
                        initialValue: newDocumentState.comuna.value,
                        onChanged: ref
                            .read(documentForm02Provider.notifier)
                            .onComunaChanged,
                        errorMessage: newDocumentState.isFormPosted
                            ? newDocumentState.comuna.errorMessage
                            : null,
                      ),
                      AdvancedAutocompleteTextFieldOverlay(
                      ...
                      AdvancedAutocompleteTextFieldOverlay(
                        ...
                        width: 300,
                        labelText: 'INGRESAR REGIÓN',
                        initialValue: newDocumentState.region.value,
                        onChanged: ref
                            .read(documentForm02Provider.notifier)
                            .onRegionChanged,
                        errorMessage: newDocumentState.isFormPosted
                            ? newDocumentState.region.errorMessage
                            : null,
                      ),
                    ],
                  ),
